...
#uses hashmap for the trie node
#time complexity: O(n) where n is the length of the word
#space complexity: O(n) where n is the number of unique characters in the trie

#most of the functions are similar, just looping through chars of the string
#for the insert, checking if c is a child, if not, create a new TrieNode
#always setting node to the node of the current character after each loop

#for the search and startsWith, checking if c is in the children of the current node
#returning false if not
#search, return if end of word, startsWith, return true if we reach the end of the prefix
